...
test: lint
	...
	docker compose run --rm cli eval-file wp-content/plugins/dzen-chat/tests/feedback-contracts.php
	docker compose run --rm cli eval-file wp-content/plugins/dzen-chat/tests/date-contracts.php
	...
	docker compose run --rm cli eval-file wp-content/plugins/dzen-chat/tests/file-contracts.php
	docker compose run --rm cli eval-file wp-content/plugins/dzen-chat/tests/page-index-contracts.php
	docker compose run --rm cli eval-file wp-content/plugins/dzen-chat/tests/page-exclusion-contracts.php
